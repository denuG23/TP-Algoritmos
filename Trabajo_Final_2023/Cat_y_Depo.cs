...
namespace Trabajo_Final_2023
{
    public class Cat_y_Depo
    {
        ...
        public int Cupo{
         ...
         public Entrenador EntrenadorAsignado{
            set {entrenadorAsignado=value;}
            get {return entrenadorAsignado;}
        }
        ...
        public void baja_Niño(Niño n){            
            listaNiños.Remove(n);
            Console.WriteLine("Ha dado de baja exitosamente a " + n.Nombre);
        }
        ...
        public ArrayList retornaListaNiños(){
        	return listaNiños;
        }
        ...
        public void pagarCuota(int dniP, int mesP){
            foreach (Niño n in listaNiños){
                if (n.Dni == dniP){
                    if (n.Cod_socio>0){
                        ...
                        Console.WriteLine("se aplica descuento de socio, por el deporte ademas debe abonar: " + auxiliar);
        	...
        	Console.WriteLine("el dni ingresado no coincide con un niño");
        }
